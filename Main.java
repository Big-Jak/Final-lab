...
public class Main implements FileOperations, ReportGenerator {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("1. " + patientsFile);
            System.out.println("2. " + appointmentsFile);
            System.out.println("\nSample file formats:");
            System.out.println("\nPatients file format:");
            System.out.println("# Patient data format: patientId,name,age,gender,email,phone");
            System.out.println("1,John Doe,35,Male,john.doe@email.com,555-0101");
            System.err.println("\nAppointments file format:");
            System.out.println("# Appointment data format: ID,year,month,day,date,hour,minute,doctorName,goal");
            System.out.println("1,2025,12,10,2025-12-10,9,30,Dr. Smith,General Checkup");
        }
    }
}